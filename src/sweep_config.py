...
# DATA_DIR is re-used so sweep outputs land in <root>/data/ regardless of
# the caller's working directory.
from pockmark_model import DATA_DIR, PERM_FACTOR


# ── Output files ────────────────────────────────────────────────────────────
MAIN_HDF5 = str(DATA_DIR / "groundwater_sweep_profiles.h5")
MAIN_CSV  = str(DATA_DIR / "groundwater_sweep_summary.csv")
SENS_HDF5 = str(DATA_DIR / "geometry_sensitivity_profiles.h5")
SENS_CSV  = str(DATA_DIR / "geometry_sensitivity_summary.csv")
